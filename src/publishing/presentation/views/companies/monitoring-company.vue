...
.bus-card {
  ...
  position: relative; /* Para el botón eliminar absoluto */
}
...
.card-header {
  ...
  padding-right: 20px; /* Espacio para el botón delete */
}

.bus-id { font-size: 1.25rem; font-weight: 700; color: #333; margin: 0; font-family: serif; }
...
.modal-title { color: #2e7d32; margin-bottom: 1.5rem; text-align: center; font-weight: 700; }
.modal-form { display: flex; flex-direction: column; gap: 1rem; }
.form-group { display: flex; flex-direction: column; gap: 0.5rem; }
.form-group label { font-weight: 600; font-size: 0.9rem; color: #333; }
.form-group input, .form-group select {
  padding: 0.7rem; border: 1px solid #ddd; border-radius: 8px;
...
.btn-cancel, .btn-save {
  flex: 1; padding: 0.8rem; border: none; border-radius: 8px; font-weight: 600; cursor: pointer;
}
